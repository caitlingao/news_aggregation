...
class User < ApplicationRecord
  ...
  ACCESSABLE_ATTRS = %i[login name email avatar current_password password password_confirmation _rucaptcha]
  ...
  scope :fields_for_list, lambda {
    select(:type, :id, :name, :login, :email, :avatar, :created_at, :updated_at)
  }
